...
var _require = require('../models/ProductModel.js'),
  getProducts = _require.getProducts,
  getProductById = _require.getProductById,
  insertProduct = _require.insertProduct,
...
// Get all products
var showProducts = /*#__PURE__*/function () {
  ...
  return function showProducts(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Get single product
var showProductById = /*#__PURE__*/function () {
  ...
  return function showProductById(_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 5:
          id = req.params.id;
          _context4.next = 8;
          return updateProductById(data, id);
        case 8:
